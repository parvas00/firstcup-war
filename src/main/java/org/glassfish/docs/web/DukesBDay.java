 ...
 */
package org.glassfish.docs.web;

import org.glassfish.docs.ejb.DukesBirthdayBean;
...
public class DukesBDay implements Serializable {
    ...
    private static final Logger logger = Logger.getLogger("org.glassfish.docs.web.DukesBDay");
